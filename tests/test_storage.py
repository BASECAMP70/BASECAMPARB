...
def test_save_and_load_time_entries(tmp_path, monkeypatch):
    import timesheet.storage as storage
    monkeypatch.setattr(storage, "DATA_DIR", tmp_path)
...
def test_save_and_load_expenses(tmp_path, monkeypatch):
    import timesheet.storage as storage
    monkeypatch.setattr(storage, "DATA_DIR", tmp_path)
...
def test_save_and_load_invoices(tmp_path, monkeypatch):
    import timesheet.storage as storage
    monkeypatch.setattr(storage, "DATA_DIR", tmp_path)
